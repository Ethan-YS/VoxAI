...
详见 [隐私政策](docs/privacy.html)（即将上线）。
...
VoxAI 是 [VoxSage](https://github.com/Ethan-YS/VoxSage) 的姊妹仓——
...
Full privacy policy: `docs/privacy.html` (coming online with App Store launch).
